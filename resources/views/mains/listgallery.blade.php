...
@section('title', '| View All Gallery Images')
      ...
      <div class="col-md-12 chit-chat-layer1-left">
               <div class="work-progres">
                     ...
                     <tr>
                            ...
                            <td>{{$thumbnail->id}}</td>
							<td><img src="{{asset('images/cabal/gallery/'.$thumbnail->img_scr)}}" height="40" width="40"></td>
                            ...
                            <td>
                                  <a href="{{route('gallerys.show', $thumbnail->id)}}" class="btn btn-default btn-sm btn-success"><i class="fa fa-eye" aria-hidden="true"></i></a>
                            </td>

                            <td>
					            {!!Form::open(['route' => ['gallerys.destroy', $thumbnail->id], 'method' => 'DELETE', 'onsubmit' => 'return ConfirmDelete()'])
					            !!}
